...
def run_anomaly_detection():
    ...
    # Load data
    file_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), '../data/Shot june2025-Parametric DB.xlsx')
    approved_file_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), '../data/Approved Anomaly Values.xlsx')
...
def validate_uploaded_values(uploaded_file):
    ...
    approved_file_path = r'C:\Users\145989\OneDrive - Arrow Electronics, Inc\Desktop\sql OUTPUT\1st project ML Parametric\API\Approved Anomaly Values.xlsx'
